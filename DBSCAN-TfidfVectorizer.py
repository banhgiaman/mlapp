...
db = DBSCAN(eps=0.95, min_samples=100).fit(vector)

print('Negative samples accuracy: ' + str(metrics.accuracy_score(df.target[:6806], db.labels_[:6806]) * 100))
print('Positive samples accuracy: ' + str(metrics.accuracy_score(df.target[6806:], db.labels_[6806:]) * 100))
