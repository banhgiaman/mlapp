...
print('Negative samples accuracy: ' + str(metrics.accuracy_score(df.target[:5000], kmeans.labels_[:5000]) * 100))
print('Positive samples accuracy: ' + str(metrics.accuracy_score(df.target[5000:], kmeans.labels_[5000:]) * 100))
